...
<template>
  <div class="writer-content pa-4 d-flex flex-column">
    ...
    <div class="btn-container d-flex justify-end">
      <VBtn class="d-flex align-center" color="#FB813E" :disabled="startLoading || !isAllQuestionsAnswered"
        :loading="startLoading" @click="logQuestions">
        <svg class="icon" fill="none" height="21" viewBox="0 0 20 21" width="20" xmlns="http://www.w3.org/2000/svg">
