<template>
    <div>
        <ReportsNavBar />
        <Statistics :campaigns="campaigns" :communication-rules-summary="communicationRulesSummary"
            :consultations-smmary="consultationsSmmary" :control-rules-summary="controlRulesSummary"
