export default {
  ...
  wallet_balance_note:
    'يمكنك الضغط على الصندوق لاستخدام رصيد المحفظة في عملية الشراء.',
  payment_method_slogan: 'حدد وسيلة الدفع او ادفع عن طريق آبل باي.',
  bank_card: 'بطاقة بنكية',
  mada_card: 'بطاقة مدى',
  pay_with: 'ادفع عن طريق',
  payment_method_desc:
    'هذا نص عن الشروط والأحكام والضرائب وسياسة الاسترجاع الخاصة بمنصة ماتركس.',
  apply: 'تطبيق',
  ...
  identity_id: 'الهوية الإعلانية',
  cta: 'زر الدعوة لاتِّخاذ إجراء',
  APPLY_NOW: 'قدم الآن',
  BOOK_NOW: 'احجز الآن',
  CALL_NOW: 'اتصل الآن',
  CONTACT_US: 'اتصل بنا',
  DOWNLOAD_NOW: 'حمل الآن',
  EXPERIENCE_NOW: 'جرب الآن',
  GET_QUOTE: 'احصل على عرض',
  GET_SHOWTIMES: 'احصل على أوقات العرض',
  GET_TICKETS_NOW: 'احصل على التذاكر الآن',
  INSTALL_NOW: 'ثبت الآن',
  INTERESTED: 'مهتم',
  LEARN_MORE: 'تعرف على المزيد',
  LISTEN_NOW: 'استمع الآن',
  ORDER_NOW: 'اطلب الآن',
  PLAY_GAME: 'العب اللعبة',
  PREORDER_NOW: 'اطلب مسبقًا الآن',
  ...
  VISIT_STORE: 'زر المتجر',
  WATCH_LIVE: 'شاهد مباشرة',
  WATCH_NOW: 'شاهد الآن',
  ...
  add_new_ad_slogan: 'قم بتعبئة الحقول لعمل إعلان جديد ويمكنك التعديل على الإعلان لاحقاً.',
  ad_url: 'الرابط (URL)',
  add_url: 'أضف الرابط',
  product: 'المنتج',
  season: 'الموسم',
  marketing_method: 'الأسلوب التسويقي',
  type: 'النوع',
  op_notes: 'ملاحظات (اختياري)',
  enter_notes: 'أدخل الملاحظات',
  team_work: 'فريق العمل',
  writer: 'الكاتب',
  editor_designer: 'المونتير/ المصمم',
  share_url: 'مشاركة الرابط',
  public_link_for_entry: 'الرابط العام للإدخال',
  add_ad: 'أضف الإعلان',
  return: 'عودة',
  easily_add_new_ads_to_your_ad_library: 'إضافة الإعلانات الجديدة إلى مكتبة الإعلانات بسهولة.',
